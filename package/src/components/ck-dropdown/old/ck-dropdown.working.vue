...
section.dropDownMenuWrapper
  ...
  //- wrapper
  .iconWrapper
    .bar1(:class="{ 'bar1--open' : isOpen }")
    .bar2(:class="{ 'bar2--open' : isOpen }")
    .bar3(:class="{ 'bar3--open' : isOpen }")
  //- menu
  section.dropdownMenu(v-if="isOpen")
    .menuArrow
    slot
</template>
...
function openClose() {
  const closeListerner = (e) => {
    if (catchOutsideClick(e, menuRef.value ) )
