<template lang="pug">
ck-button.mr-2(@click="isActivePopup = true")
  | Popup
ck-button.mr-2(@click="isActiveConfirm = true")
  | Confirm
ck-button.mr-2(@click="isActivePopupNotCloseBtn = true")
  | Not close btn
ck-button.mr-2(@click="isActivePopupNotCloseByBg = true")
  | Not close by bg
